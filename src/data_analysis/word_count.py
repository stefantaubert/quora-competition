...
plt.hist(dist_train, bins=40, range=[0, 40], color='royalblue', alpha=0.4,normed=True, label='Trainingsset')
plt.hist(dist_test, bins=40, range=[0, 40], color='seagreen', normed=True, alpha=0.5, label='Testset')
